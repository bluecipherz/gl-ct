...
class SubCategoryTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        $cats = array(
			...
			['id' => 35, 'name' => 'Furniture & Home Garden', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Gaming', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Home Appliances', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Jewellery & Watches', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Lost / Found', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Misc', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Mobile Phones & PDAs', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Musical Instruments', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Pets', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Sport Equipments', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Stuff Wanted', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Ticket & Voucher', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'Toys', 'category_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],

            /* PROPERTY FOR SALE */

			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 6, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 6, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 6, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 6, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 6, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			...
			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 6, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 6, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 12, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 12, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 12, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 12, 'created_at' => new DateTime, 'updated_at' => new DateTime],
			['id' => 35, 'name' => 'IndustrialManufacturing', 'category_id' => 12, 'created_at' => new DateTime, 'updated_at' => new DateTime],
